...
class CreateWeek8sTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('week8s', function (Blueprint $table) {
        ...
        Schema::table('week8s', function (Blueprint $table) {
