...
class CreateWeek10sTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('week10s', function (Blueprint $table) {
        ...
        Schema::table('week10s', function (Blueprint $table) {
