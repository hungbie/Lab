...
class CreateWeek9sTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('week9s', function (Blueprint $table) {
        ...
        Schema::table('week9s', function (Blueprint $table) {
