...
class CreateWeek6sTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('week6s', function (Blueprint $table) {
        ...
        Schema::table('week6s', function (Blueprint $table) {
