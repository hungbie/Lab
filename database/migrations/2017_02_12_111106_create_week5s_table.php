...
class CreateWeek5sTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('week5s', function (Blueprint $table) {
        ...
        Schema::table('week5s', function (Blueprint $table) {
