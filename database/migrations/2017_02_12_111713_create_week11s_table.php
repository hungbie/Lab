...
class CreateWeek11sTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('week11s', function (Blueprint $table) {
        ...
        Schema::table('week11s', function (Blueprint $table) {
