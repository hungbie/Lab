...
class CreateWeek7sTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('week7s', function (Blueprint $table) {
        ...
        Schema::table('week7s', function (Blueprint $table) {
